...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    *************************************************************************/
    ...
    public static void setPenRadiusInPixels(double r) {
    	if (r < 0) throw new RuntimeException("pen radius must be positive");
        penRadius = r;
        BasicStroke stroke = new BasicStroke((float) penRadius * 2, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
    ...
    *************************************************************************/
    ...
    public static void main(String[] args) {
    	...
    	StdDraw.setPenRadiusInPixels(0.5);
    	StdDraw.line(100, 0, 100, 512);
    }
